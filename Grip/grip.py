...
# blue_hsv = [[84, 110], [57, 186.0], [70.0, 255.0]] TODO MAYBE COMP
blue_hsv = [[84, 110], [92, 186.0], [70.0, 255.0]]
...
class RedCargo:
    ...
    def __init__(self):
        ...
        self.__resize_image_width = 300.0
        self.__resize_image_height = 230.0
        ...
        self.__hsv_threshold_hue = red_hsv[0]
        self.__hsv_threshold_saturation = red_hsv[1]
        self.__hsv_threshold_value = red_hsv[2]
...
class BlueCargo:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_input = self.blur_output
        self.__hsv_threshold_hue = blue_hsv[0]
        self.__hsv_threshold_saturation = blue_hsv[1]
        self.__hsv_threshold_value = blue_hsv[2]
